...
export default function Programs({ setPage }: ProgramsProps) {
  ...
  const activities = [
    { 
      img: 'src/assets/images/regenerated_image_1778586985136.jpg',
      tag: 'Verified NGO',
      title: 'Helping Hands Chennai',
      desc: '25 meals dispatched'
    },
    { 
      img: 'src/assets/images/regenerated_image_1778587139002.jpg',
      tag: "NGO 'Kiran Foundation'",
      title: 'Hyderabad Hub',
      desc: '40 meals distributed'
    },
    { 
      img: 'src/assets/images/regenerated_image_1778586987689.jpg',
  ...
  const programCards = [
    {
      img: 'src/assets/images/regenerated_image_1778586989432.jpg',
      color: 'bg-primary-600',
      title: 'Campus Fridge',
      location: 'Delhi/Kodikulam'
    },
    {
      img: 'src/assets/images/regenerated_image_1778586990789.jpg',
      color: 'bg-orange-500',
      title: 'Restaurant Partners',
      location: 'Verified Safety'
    },
    {
      img: 'src/assets/images/regenerated_image_1778586992508.jpg',
      color: 'bg-blue-600',
      title: 'Community Fridges',
      location: 'Kodikulam/Anna Nagar'
    },
    {
      img: 'src/assets/images/regenerated_image_1778586993833.jpg',
      color: 'bg-green-600',
